...
const sqlString2 = `CREATE TABLE IF NOT EXISTS information (id SERIAL PRIMARY KEY, email TEXT, species TEXT, gender TEXT, petsname TEXT, breedType TEXT, breed TEXT, age INTEGER, address TEXT)`;
